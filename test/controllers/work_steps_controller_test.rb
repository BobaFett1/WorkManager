...
class WorkStepsControllerTest < ActionController::TestCase
  ...
  test "should create work_step" do
    assert_difference('WorkStep.count') do
      post :create, work_step: { AllowQuantityInput: @work_step.AllowQuantityInput, Description: @work_step.Description, DisplayName: @work_step.DisplayName }
    end
  ...
  test "should update work_step" do
    patch :update, id: @work_step, work_step: { AllowQuantityInput: @work_step.AllowQuantityInput, Description: @work_step.Description, DisplayName: @work_step.DisplayName }
    assert_redirected_to work_step_path(assigns(:work_step))
  end
